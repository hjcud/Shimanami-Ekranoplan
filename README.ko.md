...
<p align="left">
  <a href="./Docs/technical-overview.ko.md">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="./Docs/images/development-notes-button.ko.svg">
      <img src="./Docs/images/development-notes-button.ko.light.svg" alt="개발 기록" width="330">
    </picture>
  </a>&nbsp;&nbsp;
